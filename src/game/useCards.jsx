...
export default function useCards(initialComp) {
   ...
   */
  /*
    Implement a async function and use the fetch api or axios 
    to get data from the starwars api (the url is already there)
    After the data is fetched call the 'dealCards' function with 
    the results and set loading to false (useCards.jsx)
    */
